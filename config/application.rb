...
module Vocat
  class Application < Rails::Application
    ...
    config.assets.precompile += ['vendor/require/require.js', 'vendor/modernizr/modernizr-2.6.2.js', 'vendor/video.js/video.js', 'vendor/video.js/vjs.youtube.js', 'vendor/video.js/vjs.vimeo.js', 'vendor/rem_unit_polyfill/rem.min.js']
