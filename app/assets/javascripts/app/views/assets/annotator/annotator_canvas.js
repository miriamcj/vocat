...
define(function(require) {
  ...
  return AnnotatorCanvasView = (function() {
    let eraseEnabled = undefined;
    AnnotatorCanvasView = class AnnotatorCanvasView extends Marionette.ItemView {
      static initClass() {
    ...
    AnnotatorCanvasView.initClass();
    return AnnotatorCanvasView;
  })();
});
