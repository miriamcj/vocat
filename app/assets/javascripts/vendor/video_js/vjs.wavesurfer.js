...
}(this, function(WaveSurfer)
{
    ...
    videojs.Waveform = videojs.Component.extend({
        ...
        initialize: function(opts)
        {
            ...
            console.log(this.player().height(),'h');
            that = this
            setTimeout(function() {
                console.log(that.player().height(),'h');
            },1000)
        ...
        setCurrentTime: function(currentTime, duration)
        {
            ...
            // update control
            if(this.player().controlBar.hasOwnProperty('currentTimeDisplay')) {
        ...
        setDuration: function(duration)
        {
            ...
            // update control
            if(this.player().controlBar.hasOwnProperty('durationDisplay')) {
