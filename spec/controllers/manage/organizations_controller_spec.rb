...
RSpec.describe Manage::OrganizationsController, type: :controller do
  login_superadmin
  before do
    @request.host = "manage.vocat.dev"
  end


  # This should return the minimal set of attributes required to create a valid
  # Manage::Organization. As you add validations to Manage::Organization, be sure to
  ...
  # Manage::OrganizationsController. Be sure to keep this updated too.
  let(:valid_session) { {} }
  ...
  describe "GET #edit" do
    it "assigns the requested manage_organization as @manage_organization" do
      organization = Organization.create! valid_attributes
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested organization" do
        organization = Organization.create! valid_attributes
        put :update, params: {:id => organization.to_param, :organization => {name: "Changed"}}, session: valid_session
        organization.reload
        expect(assigns(:organization)).to eq(organization)
      end
