...
class PresentationsControllerTest < ActionController::TestCase
  ...
  test "should create presentation" do
    assert_difference('Presentation.count') do
      post :create, presentation: { description: @presentation.description, name: @presentation.name, video: @presentation.video }
    end
  ...
  test "should update presentation" do
    put :update, id: @presentation, presentation: { description: @presentation.description, name: @presentation.name, video: @presentation.video }
    assert_redirected_to presentation_path(assigns(:presentation))
  end
