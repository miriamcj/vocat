...
ActiveRecord::Schema.define(version: 2019_04_15_195127) do
  ...
  create_table "attachment_variants", id: :serial, force: :cascade do |t|
  ...
  create_table "course_events", id: :serial, force: :cascade do |t|
    ...
    t.integer "submission_id"
    t.index ["loggable_type", "loggable_id"], name: "index_course_events_on_loggable_type_and_loggable_id"
  end

  create_table "course_requests", id: :serial, force: :cascade do |t|
    t.string "name"
    t.string "department"
    t.string "section"
    t.string "number"
  ...
  create_table "evaluations", id: :serial, force: :cascade do |t|
    ...
    t.index ["scores"], name: "index_evaluations_on_scores"
  end
  ...
  create_table "semesters", id: :serial, force: :cascade do |t|
    ...
    t.date "end_date"
    t.integer "organization_id"
    t.index ["organization_id"], name: "index_semesters_on_organization_id"
  end
  ...
  create_table "visits", id: :serial, force: :cascade do |t|
    ...
    t.datetime "created_at"
    t.datetime "updated_at"
    t.index ["visitable_course_id"], name: "index_visits_on_visitable_course_id"
