  ...
  rand(1..4).times do
    ...
    course_creators.length.times do |i|
      ...
      if rand > 0.3
        ...
        values = "VALUES ('small.mp4', 'video/mp4', '383631', '2013-05-16 20:51:05', '#{Attachment::TRANSCODING_STATUS_SUCCESS}', '2013-05-16 20:51:05', '2013-05-16 20:51:05', '#{submission.id}', 'Submission')"
