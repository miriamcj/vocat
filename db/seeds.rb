  ...
  rand(1..4).times do
    ...
    course_creators.length.times do |i|
      ...
      if rand > 0.3
        ...
        values = "VALUES ('The_Big_Lebowski_Official_Trailer.avi', 'video/avi', '33561132', '2013-08-12 22:39:42', '#{Attachment::TRANSCODING_STATUS_SUCCESS}', '2013-08-12 22:39:42', '2013-08-12 22:39:42', '#{submission.id}', 'Submission')"
