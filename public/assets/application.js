...
(function() {
  this.JST || (this.JST = {});
  this.JST["backbone/templates/evaluatable_exhibit"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="well row">\n  <div class="row" xmlns="http://www.w3.org/1999/html">\n    <div class="exhibit-attachment span3">\n      ');  if (exhibit.get('submission')) { ; __p.push('\n          <div class="placeholder-red">\n            Submission: LINK TO SUBMISSION\n          </div>\n      ');  } else { ; __p.push('\n          <div class="placeholder">\n            No submission has been saved for this user/project\n          </div>\n      ');  } ; __p.push('\n      <div style="margin-bottom: 20px;">\n        <small class="with-gray">No Instructior Comments</small><br>\n        <small class="with-gray"><a href="#">3 Peer Comments</a></small>\n      </div>\n      <a class="btn btn-mini" href="#">+ See all feedback</a>\n    </div>\n    <div class="exhibit-content span9">\n      <div class="row">\n        <div class="span7">\n          <h5><a href="#">',  exhibit.get('course_name') ,'</a></h5>\n          <h5>Creator: <a href="#">',  exhibit.get('creator_name') ,'</a></h5>\n          <h3><a href="#">',  exhibit.get('project_name') ,'</a></h3>\n        </div>\n        <div class="text-right span2">\n          <small class="with-gray with-block">Unevaluated <b class="badge">&#8203;</b></small>\n          <!--<small class="with-gray with-block">Evaluated <b class="badge badge-info">&#8203;</b></small>-->\n        </div>\n      </div>\n      <ul class="unstyled evaluation-list with-gray-dark">\n        <li class="row">\n          <div class="span8 evaluation-wrapper">\n            <div class="evaluation-box evaluated" style="width: 60%;">Evaluated</div>\n          </div>\n          <div class="span1">\n            <div class="evaluation-box text-center">60%</div>\n          </div>\n        </li>\n        <li class="row">\n          <div class="span8 evaluation-wrapper">\n            <div class="evaluation-box unevaluated">Unevaluated</div>\n          </div>\n          <div class="span1">\n            <div class="evaluation-box text-center">--</div>\n          </div>\n        </li>\n      </ul>\n      <a class="btn btn-mini" href="#">+ Expand details</a>\n    </div>\n  </div>\n </div>\n');}return __p.join('');};
}).call(this);
(function() {
  this.JST || (this.JST = {});
  this.JST["backbone/templates/exhibit_list"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div></div>\n');}return __p.join('');};
}).call(this);
(function() {
  this.JST || (this.JST = {});
  this.JST["backbone/templates/unevaluatable_exhibit"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="well row">\n  <div class="row" xmlns="http://www.w3.org/1999/html">\n    <div class="exhibit-attachment span3">\n      ');  if (exhibit.get('submission')) { ; __p.push('\n          <div class="placeholder-red">\n            Submission: LINK TO SUBMISSION\n          </div>\n      ');  } else { ; __p.push('\n          <div class="placeholder">\n            No submission has been saved for this user/project\n          </div>\n      ');  } ; __p.push('\n      <div style="margin-bottom: 20px;">\n        <small class="with-gray">No Instructior Comments</small><br>\n        <small class="with-gray"><a href="#">3 Peer Comments</a></small>\n      </div>\n      <a class="btn btn-mini" href="#">+ See all feedback</a>\n    </div>\n    <div class="exhibit-content span9">\n      <div class="row">\n        <div class="span7">\n          <h5><a href="#">',  exhibit.get('course_name') ,'</a></h5>\n          <h5>Creator: <a href="#">',  exhibit.get('creator_name') ,'</a></h5>\n          <h3><a href="#">',  exhibit.get('project_name') ,'</a></h3>\n        </div>\n        <div class="text-right span2">\n          <small class="with-gray with-block">Unevaluated <b class="badge">&#8203;</b></small>\n          <!--<small class="with-gray with-block">Evaluated <b class="badge badge-info">&#8203;</b></small>-->\n        </div>\n      </div>\n      <ul class="unstyled evaluation-list with-gray-dark">\n        <li class="row">\n          <div class="span8 evaluation-wrapper">\n            <div class="evaluation-box evaluated" style="width: 60%;">Evaluated</div>\n          </div>\n          <div class="span1">\n            <div class="evaluation-box text-center">60%</div>\n          </div>\n        </li>\n        <li class="row">\n          <div class="span8 evaluation-wrapper">\n            <div class="evaluation-box unevaluated">Unevaluated</div>\n          </div>\n          <div class="span1">\n            <div class="evaluation-box text-center">--</div>\n          </div>\n        </li>\n      </ul>\n      <a class="btn btn-mini" href="#">+ Expand details</a>\n    </div>\n  </div>\n </div>\n');}return __p.join('');};
}).call(this);
(function() {
...
(function() {
  ...
  Vocat.Models.Creator = (function(_super) {
...
(function() {
  ...
  Vocat.Models.Exhibit = (function(_super) {

    __extends(Exhibit, _super);

    function Exhibit() {
      return Exhibit.__super__.constructor.apply(this, arguments);
    }

    Exhibit.prototype.relations = [
      {
...
(function() {
  ...
  Vocat.Models.Project = (function(_super) {
...
(function() {
  ...
  Vocat.Models.Submission = (function(_super) {
    ...
    Submission.prototype.relations = [
      {
        type: Backbone.HasOne,
        key: 'exhibit',
...
(function() {
  ...
  Vocat.Views.EvaluatableExhibit = (function(_super) {

    __extends(EvaluatableExhibit, _super);

    function EvaluatableExhibit() {
      return EvaluatableExhibit.__super__.constructor.apply(this, arguments);
    }

    EvaluatableExhibit.prototype.template = JST["backbone/templates/evaluatable_exhibit"];

    EvaluatableExhibit.prototype.initialize = function(options) {
      return this.role = 'evaluator';
    };

    EvaluatableExhibit.prototype.render = function() {
      return $(this.el).html(this.template({
        exhibit: this.model
      }));
    };

    return EvaluatableExhibit;
...
(function() {
  ...
  Vocat.Views.ExhibitList = (function(_super) {

    __extends(ExhibitList, _super);

    function ExhibitList() {
      return ExhibitList.__super__.constructor.apply(this, arguments);
    }

    ExhibitList.prototype.template = JST["backbone/templates/exhibit_list"];

    ExhibitList.prototype.initialize = function(options) {
      this.exhibitCollection = window.Vocat.Instantiated.Collections.Exhibit;
      this.role = this.$el.data('role');
      return this.render();
    };

    ExhibitList.prototype.render = function() {
      var _this = this;
      this.$el.html(this.template({}));
      return this.exhibitCollection.each(function(exhibit) {
        var childView;
        if (_this.role === 'creator') {
          childView = new Vocat.Views.UnevaluatableExhibit({
            model: exhibit
          });
        } else {
          childView = new Vocat.Views.EvaluatableExhibit({
            model: exhibit
          });
        }
        return _this.$el.append(childView.render());
      });
    };
...
(function() {
  ...
  Vocat.Views.UnevaluatableExhibit = (function(_super) {

    __extends(UnevaluatableExhibit, _super);

    function UnevaluatableExhibit() {
      return UnevaluatableExhibit.__super__.constructor.apply(this, arguments);
    }

    UnevaluatableExhibit.prototype.template = JST["backbone/templates/unevaluatable_exhibit"];

    UnevaluatableExhibit.prototype.initialize = function(options) {
      return this.role = 'creator';
    };

    UnevaluatableExhibit.prototype.render = function() {
      return $(this.el).html(this.template({
        exhibit: this.model
      }));
    };

    return UnevaluatableExhibit;
...
(function() {
  ...
  Vocat.Routers.AppRouter = (function(_super) {
    ...
    AppRouter.prototype.initalize = function(options) {
      this.bootstrapCollections();
      return this.createViews();
    };

    AppRouter.prototype.bootstrapCollections = function() {
      var _this = this;
      return _.each(window.Vocat.Bootstrap.Collections, function(collectionData, collectionName) {
        if (window.Vocat.Instantiated.Collections[collectionName] != null) {
          return window.Vocat.Instantiated.Collections[collectionName].reset(collectionData);
        } else {
          return window.Vocat.Instantiated.Collections[collectionName] = new Vocat.Collections[collectionName](collectionData);
        }
      });
    };

    AppRouter.prototype.createViews = function(el) {
      var _this = this;
      return $('[data-view]').each(function(i, el) {
        var $el, viewName;
        $el = $(el);
        viewName = $el.attr('data-view');
        return window.Vocat.Instantiated.Views[viewName] = new Vocat.Views[viewName]({
          el: $(el)
        });
      });
    };
...
(function() {
  ...
  Vocat.Collections.Creator = (function(_super) {
    ...
    Creator.prototype.model = Vocat.Models.Creator;
...
(function() {
  ...
  Vocat.Collections.Exhibit = (function(_super) {
    ...
    Exhibit.prototype.model = Vocat.Models.Exhibit;
...
(function() {
  ...
  Vocat.Collections.Project = (function(_super) {
    ...
    Project.prototype.model = Vocat.Models.Project;
...
(function() {
  ...
  Vocat.Collections.Submission = (function(_super) {
    ...
    Submission.prototype.model = Vocat.Models.Submission;
...
(function() {
  ...
  $(function() {
    return $('#course_select').change(function() {
      var id, re, replacer, startUrl, url;
      id = $(this).val();
      if (id) {
        re = /(course\/)(\d)+/;
        startUrl = $(this).data('url');
        if (startUrl.match(re)) {
          replacer = function(match, p1, p2) {
            return p1 + id;
          };
          url = $(this).data("url").replace(re, replacer);
        } else {
          url = startUrl + "/" + id;
        }
      } else {
  ...
  $(function() {
    return $('#fileupload').fileupload({
      ...
      start: function(e, data) {
        return $("#progress").text("File uploading...");
      },
